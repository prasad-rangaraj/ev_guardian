...
SCALER_PATH = os.path.join(MODELS_DIR, "sensor_scaler.joblib")
...
CONFIG_JSON_PATH = os.path.join(MODELS_DIR, "best_model_config.json")

# Physical features for LSTM input (32 features)
INPUT_FEATURES = [
    'Current', 'SoC', 'Cell1', 'Cell2', 'Cell3', 'Cell4', 'Pack_V', 'Min_Cell_V', 'Max_Cell_V', 'Cell_Imbalance',
    'T1', 'T2', 'Delta_T', 'Vib_RMS', 'Vib_Peak', 'Vib_Freq', 'CO_PPM',
    'Status_CHARGING', 'Status_DISCHARGING', 'Status_IDLE',
    'dV1_dt', 'dV2_dt', 'dV3_dt', 'dV4_dt', 'dT1_dt', 'dT2_dt', 'dCO_dt', 'dI_dt', 'dImbalance_dt', 'dSoC_dt',
